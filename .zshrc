...
#zplug "plugins/command-not-found", from:oh-my-zsh # too slow
...
POWERLEVEL9K_CONTEXT_TEMPLATE="\uf303 Thetoto"
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(virtualenv command_execution_time background_jobs status time ssh)
...
# STDERR en rouge
#export LD_PRELOAD="/home/toto/script/stderred/build/libstderred.so${LD_PRELOAD:+:$LD_PRELOAD}"
alias nold="LD_PRELOAD= "
